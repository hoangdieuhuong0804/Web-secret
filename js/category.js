...
function addCart(sanphamGia,sanphamImg,sanphamName){
  ...
  //   }
  // }
  var trcontent= '<tr> </td> <td><img src="'+sanphamImg+'" alt=""></td> <td class="tilte">'+sanphamName+'</td> <td><span>'+sanphamGia+'</span>đ</td> <td><input type="number" value="1" min="1" ></td><td><a href="#" class="dele"><i class="far fa-times-circle"></i></a></tr>'
...
//   var cartItem=document.querySelectorAll("tbody tr")
//   for(var i=0;i<cartItem.length;i++){
//     var proudctT=document.querySelectorAll(".dele")
